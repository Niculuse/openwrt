...
apply_passwall_tweaks() {
    ...
    sed -i '/^define Package\/$(PKG_NAME)\/config$/i LUCI_DEPENDS+=+haproxy +v2ray-plugin +shadowsocks-rust-sslocal +shadowsocks-rust-ssserver' $BUILD_DIR/feeds/small8/luci-app-passwall/Makefile
}
